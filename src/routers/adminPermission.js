...
adminPermissionRouter
    .post("/api/add/admin/permission", authencate(['super_admin']), validates(adminPermissionSchema), controller.addPermission.bind(controller))
    .delete("/api/delete/admin/permission/:id", authencate(['super_admin']), controller.deleteAdminPermission.bind(controller))
    .put("/api/change/admin/permission/:id", authencate(['super_admin']), validates(adminPermissionSchema), controller.updateAdminPermission.bind(controller))
