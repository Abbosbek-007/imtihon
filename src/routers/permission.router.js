...
permissionRouters
    ...
    .put("/api/change/permission/:id", authencate(['super_admin', 'admin']), validates(permissionSchema), controller.changePermission.bind(controller))
    .get("/api/all/permission", authencate(['super_admin', 'admin']), controller.allPermissions.bind(controller))
    .get("/api/own/permission/:id", authencate(['super_admin', 'admin']), controller.onePermission.bind(controller))
