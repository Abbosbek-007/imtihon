...
branchRouter
    .post("/api/add/branch", authencate(['super_admin', 'admin']), controller.addBranch.bind(controller))
    .put("/api/change/branch/:id", authencate(['super_admin', 'admin']), controller.changeBranch.bind(controller))
    .delete("/api/delete/branch/:id", authencate(['super_admin', 'admin']), controller.deleteBranch.bind(controller))
    .get("/api/all/branch", authencate(['super_admin', 'admin']), controller.getBranches.bind(controller))
